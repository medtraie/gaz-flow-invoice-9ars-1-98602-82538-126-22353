...
export default function InventoryPage() {
  ...
  // Store string values for inputs to preserve trailing zeros
  ...
  const handleChange = (
    ...
    // Store the string value to preserve trailing zeros
  ...
  // Helper function to display value (empty string if 0, otherwise the stored string or number)
  const displayValue = (index: number, field: string, value: number): string => {
    const key = getInputKey(index, field);
  ...
  const saveChanges = () => {
    ...
    setInputValues({}); // Clear input values after save
                ...
                <TableRow key={item.type}>
                  ...
                  <TableCell>
                    <Input
                      type="text"
                      inputMode="numeric"
                      value={displayValue(index, 'totalQuantity', item.totalQuantity)}
                  ...
                  <TableCell>
                    <Input
                      type="text"
                      inputMode="decimal"
                      value={displayValue(index, 'unitPrice', item.unitPrice)}
                  ...
                  <TableCell>
                    <Input
                      type="text"
                      inputMode="decimal"
                      value={displayValue(index, 'taxRate', item.taxRate)}
