...
export default function SettingsPage() {
  ...
  const handleCompanyChange = (value: "ORANGE ENERGY" | "TRADIGAZ" | "ARGANA ENERGY") => {
    setFormData(prev => ({
      ...prev,
      companyName: value
    }));
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="ORANGE ENERGY">ORANGE ENERGY</SelectItem>
                    <SelectItem value="TRADIGAZ">TRADIGAZ</SelectItem>
                    <SelectItem value="ARGANA ENERGY">ARGANA ENERGY</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-4">
                {settings.companies?.[formData.companyName]?.logo && (
                  <img 
                    src={settings.companies[formData.companyName].logo} 
                    alt={`Logo ${formData.companyName}`}
                    className="w-32 h-32 object-contain border rounded p-2"
                  />
                )}
              </div>
              <p className="text-sm text-muted-foreground">
                Logo de {formData.companyName}
              </p>
            </div>
